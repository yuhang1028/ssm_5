...
<script>
    ...
    //刷新
    function reflush() {
		location.href="${pageContext.request.contextPath}/product/findAll"
    }
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/product/productNum'">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="reflush();">
							...
							<!--数据列表-->
                            <form action="${pageContext.request.contextPath}/product/delete" method="post" id="form">
							<table id="dataList"
